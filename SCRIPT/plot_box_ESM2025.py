...
ax.text(-175.0 , -68.0 , 'ROSS', transform=ccrs.PlateCarree(),color='k',fontweight='bold',fontsize=16)
ax.text(-55.0  , -70.0 , 'FRIS', transform=ccrs.PlateCarree(),color='k',fontweight='bold',fontsize=16)
ax.text(-125.0 , -74.0 , 'AMU', transform=ccrs.PlateCarree(),color='k',fontweight='bold',fontsize=16)
...
box=box_lst[0]; ax.text(lon[box.ymin,box.xmin]-20, lat[box.ymin,box.xmin]+4,box.name,transform=ccrs.PlateCarree(),color='k',fontweight='bold',fontsize=16)
box=box_lst[1]; ax.text(lon[box.ymin,box.xmin], lat[box.ymin,box.xmin]-1,box.name,transform=ccrs.PlateCarree(),color='k',fontweight='bold',fontsize=16)
box=box_lst[2]; ax.text(lon[box.ymin,box.xmin]+30, lat[box.ymin,box.xmin]+10,box.name,transform=ccrs.PlateCarree(),color='k',fontweight='bold',fontsize=16)
box=box_lst[3]; ax.text(lon[box.ymin,box.xmin]+15, lat[box.ymin,box.xmin]+5,box.name,transform=ccrs.PlateCarree(),color='k',fontweight='bold',fontsize=16)

#pcol=ax.pcolormesh(lon,lat,bathy)
ax.set_extent(XY_lim, ccrs.PlateCarree())
plt.savefig('box_ESM2025.png', format='png', dpi=150)
plt.show()
