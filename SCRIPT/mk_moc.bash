...
FILEV=`ls *${RUN_NAME}o_${FREQ}_${TAG}*_grid[-_]V.nc`
FILEU=`ls *${RUN_NAME}o_${FREQ}_${TAG}*_grid[-_]U.nc`
FILET=`ls *${RUN_NAME}o_${FREQ}_${TAG}*_grid[-_]T.nc`
FILES=`ls *${RUN_NAME}o_${FREQ}_${TAG}*_grid[-_]T.nc`
