...
set -x
# FRIS shelf
$CDFPATH/cdfmkmask -zoom -63 -25 -80 -71 -f mask.nc -v tmask -zoomvar bathy_metry 1000 6000 -o msk_FRIS_shelf.nc -2d -filllonlat -32.224 -73.091 -r
...
# ROSS shelf
$CDFPATH/cdfmkmask -zoom 166 -158 -79 -71  -f mask.nc -v tmask -zoomvar bathy_metry 0 1000 -o msk_ROSS_shelf.nc -2d
...
# AMU  shelf
$CDFPATH/cdfmkmask -zoom -114 -101 -76 -70 -f mask.nc -v tmask -zoomvar bathy_metry 1000 6000 -o msk_AMUS_shelf.nc -2d -filllonlat -113      -70.746 -r
...
# AMUXL 
$CDFPATH/cdfmkmask -zoom -140 -86 -80 -60 -f mask.nc -v tmask -o msk_AMUXL.nc 
...
# GETZ shelf
$CDFPATH/cdfmkmask  -zoom -137 -114 -76 -70 -f mask.nc -v tmask -zoomvar bathy_metry 1000 6000 -o msk_GETZ_shelf.nc -2d -filllonlat -118.993 -70.746 -r
